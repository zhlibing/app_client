    ...
    private class DragHelperCallback extends ViewDragHelper.Callback {
        ...
        public boolean tryCaptureView(View child, int pointerId) {
            ...
            if (shouldCapture) {
                ...
                ObjectAnimator anim5 = ObjectAnimator.ofFloat(child, "scaleX",
                        1.0f, 0.4f);

                ObjectAnimator anim6 = ObjectAnimator.ofFloat(child, "scaleY",
                        1.0f, 0.4f);

                AnimatorSet animSet = new AnimatorSet();
                animSet.play(anim6).with(anim5);
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            ObjectAnimator anim5 = ObjectAnimator.ofFloat(releasedChild, "scaleX",
                    0.4f, 1.0f);

            ObjectAnimator anim6 = ObjectAnimator.ofFloat(releasedChild, "scaleY",
                    0.4f, 1.0f);
