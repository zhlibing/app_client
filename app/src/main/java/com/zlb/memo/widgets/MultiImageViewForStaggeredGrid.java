...
import com.zlb.memo.utils.DensityUtil;
...
public class MultiImageViewForStaggeredGrid extends LinearLayout {
    ...
    public MultiImageViewForStaggeredGrid(Context context) {
        super(context);
    }

    public MultiImageViewForStaggeredGrid(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
