...
import com.zlb.memo.widgets.spannable.CircleMovementMethod;
import com.zlb.memo.widgets.spannable.SpannableClickable;
...
public class CommentListView extends LinearLayout {
    ...
    private View getView(final int position){
        ...
        if (bean.getToReplyUser() != null) {
            toReplyName = bean.getToReplyUser().getNickName();
        }
