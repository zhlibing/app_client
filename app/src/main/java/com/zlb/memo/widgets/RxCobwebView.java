...
import com.vondear.rxtools.view.RxRotateTool;
...
public class RxCobwebView extends View {
    ...
    private void initEvent() {
        ...
        mSpiderNamePaint.setColor(Color.parseColor("#777777"));
    ...
    private void initAttrs(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, com.vondear.rxtools.R.styleable.RxCobwebView);//获得这个控件对应的属性。
        mSpiderColor = a.getColor(com.vondear.rxtools.R.styleable.RxCobwebView_spiderColor, getResources().getColor(com.vondear.rxtools.R.color.teal));//蛛网内部颜色
        mSpiderRadiusColor = a.getColor(com.vondear.rxtools.R.styleable.RxCobwebView_spiderRadiusColor, Color.WHITE);//蛛网半径颜色
        mSpiderLevelStrokeColor = a.getColor(com.vondear.rxtools.R.styleable.RxCobwebView_spiderLevelColor, getResources().getColor(com.vondear.rxtools.R.color.custom_progress_orange_progress));//蛛网等级描边颜色
        mSpiderLevelColor = RxImageTool.changeColorAlpha(mSpiderLevelStrokeColor, (255 / 2));//蛛网等级颜色
        mSpiderLevelStroke = a.getBoolean(com.vondear.rxtools.R.styleable.RxCobwebView_spiderLevelStroke, true);//是否需要 蛛网等级描边
        mSpiderRotate = a.getBoolean(com.vondear.rxtools.R.styleable.RxCobwebView_spiderRotate, true);//是否需要 蛛网等级描边
        mSpiderLevelStrokeWidth = a.getFloat(com.vondear.rxtools.R.styleable.RxCobwebView_spiderLevelStrokeWidth, 3f);//蛛网等级描边 宽度
        mSpiderMaxLevel = a.getInteger(com.vondear.rxtools.R.styleable.RxCobwebView_spiderMaxLevel, 4);//蛛网最大层级数
        mSpiderNameSize = a.getDimensionPixelSize(com.vondear.rxtools.R.styleable.RxCobwebView_spiderNameSize, RxImageTool.dp2px(16));//标题字体大小
        a.recycle();
    }
    ...
    private void drawSpiderName(Canvas canvas) {
        ...
        for (int position = 0; position < mSpiderNumber; position++) {
            ...
            nextPointX = (float) (center + Math.sin(nextRadians - mRotateAngle) * currentRadius - textWidth / 2)+5f;
