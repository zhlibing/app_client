...
public class BuilderManager {
    ...
    private static int[] imageResources = new int[]{
            R.drawable.normal_pingtuan,
            R.drawable.normal_dav,
            R.drawable.normal_daren,
            R.drawable.normal_dy,
            R.drawable.normal_lxz,
            R.drawable.normal_shanghu,
            R.drawable.normal_youhuiquan
    };
    private static int[] textResources = new int[]{
            R.string.home_pingyou,
            R.string.home_dav,
            R.string.home_daren,
            R.string.home_daoyou,
            R.string.home_lvxingzhe,
            R.string.home_shanghu,
            R.string.home_youhuiquan
    };
