...
public class PublishPingYouEditIntruduceActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_publish_pingyou_edit_intruduce);
        ...
        if (group != null) {
            ...
            if (flag == 0) {//新建笔记
                if (noteTitle.length() == 0 && noteContent.length() == 0) {
                    if (!isBackground) {
                        Toast.makeText(PublishPingYouEditIntruduceActivity.this, "请输入内容", Toast.LENGTH_SHORT).show();
                    }
                } else {
        ...
        subsInsert = Observable.create(new Observable.OnSubscribe<String>() {
            ...
            public void call(Subscriber<? super String> subscriber) {
                try {
                    ...
                    int width = ScreenUtils.getScreenWidth(PublishPingYouEditIntruduceActivity.this);
                    int height = ScreenUtils.getScreenHeight(PublishPingYouEditIntruduceActivity.this);
