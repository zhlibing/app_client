...
import com.zlb.memo.adapter.viewholder.CircleViewHolder;
import com.zlb.memo.adapter.viewholder.ImageViewHolder;
import com.zlb.memo.adapter.viewholder.URLViewHolder;
import com.zlb.memo.adapter.viewholder.VideoViewHolder;
import com.zlb.memo.bean.ActionItem;
...
import com.zlb.memo.mvp.presenter.CirclePresenter;
import com.zlb.memo.utils.DatasUtil;
import com.zlb.memo.utils.GlideCircleTransform;
import com.zlb.memo.utils.UrlUtils;
import com.zlb.memo.widgets.CircleVideoView;
...
import com.zlb.memo.widgets.PraiseListView;
import com.zlb.memo.widgets.SnsPopupWindow;
import com.zlb.memo.widgets.dialog.CommentDialog;
...
public class CircleAdapter extends BaseRecycleViewAdapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        if(getItemViewType(position)==TYPE_HEAD){
            ...
            String headImg = circleItem.getUser().getAvatar();
                ...
                if(hasComment){//处理评论列表
                    holder.commentList.setOnItemClickListener(new CommentListView.OnItemClickListener() {
                        ...
                        public void onItemClick(int commentPosition) {
                            ...
                            if(DatasUtil.curUser.getUserId().equals(commentItem.getUser().getUserId())){//复制或者删除自己的评论
            ...
            //判断是否已点赞
            String curUserFavortId = circleItem.getCurUserFavortId(DatasUtil.curUser.getUserId());
