...
import com.zhuguangmama.imagepicker.widget.AvatarRectView;
import com.zhuguangmama.imagepicker.widget.SuperImageView;
...
//        Bitmap srcBitmap = ((BitmapDrawable) superImageView.getDrawable()).getBitmap();
        Bitmap srcBitmap =drawableToBitmap(superImageView.getDrawable());
