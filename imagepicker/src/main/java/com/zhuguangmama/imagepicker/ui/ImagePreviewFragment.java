...
import com.zhuguangmama.imagepicker.ImagePresenter;
import com.zhuguangmama.imagepicker.R;
import com.zhuguangmama.imagepicker.UilImagePresenter;
import com.zhuguangmama.imagepicker.bean.ImageItem;
import com.zhuguangmama.imagepicker.widget.TouchImageView;
...
public class ImagePreviewFragment extends Fragment{
    ...
    class TouchImageAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            bundle.putBoolean(SinglePreviewFragment.KEY_ENABLESINGLETAP,enableSingleTap);
    ...
    public static class SinglePreviewFragment extends Fragment {
        ...
        public static final String KEY_ENABLESINGLETAP="enablesingletap";
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            enableSingleTap=bundle.getBoolean(KEY_ENABLESINGLETAP);
            url = imageItem.path;
            ...
            imageView.setOnDoubleTapListener(new GestureDetector.OnDoubleTapListener() {
                ...
                public boolean onSingleTapConfirmed(MotionEvent e) {
                    if (enableSingleTap) {
                        if(getActivity() instanceof OnImageSingleTapClickListener){
                            ((OnImageSingleTapClickListener)getActivity()).onImageSingleTap(e);
                        }
                    }
                    return false;
                }
