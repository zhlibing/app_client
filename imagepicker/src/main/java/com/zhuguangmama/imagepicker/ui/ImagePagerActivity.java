...
public class ImagePagerActivity extends Activity {
    ...
    //    public static final String API_URL = "http://api.zhuguangmama.com/service";//外网
    public static final String API_URL = "http://scrf.zhuguangmama.com/sjbx";//外网
    //        public static final String API_URL = "http://192.168.0.36:9000/service";//内网
    ...
    private void addGuideView(LinearLayout guideGroup, int startPos, ArrayList<String> imgUrls) {
        if (imgUrls != null && imgUrls.size() > 0) {
            ...
            for (int i = 0; i < imgUrls.size(); i++) {
                ...
                view.setBackgroundDrawable(getApplicationContext().getResources().getDrawable(R.drawable.select_big_pic));
                view.setSelected(i == startPos ? true : false);
                LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(getResources().getDimensionPixelSize(R.dimen.activity_horizontal_margin),
    ...
    private static class ImageAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            if (view != null) {
                ...
                String url = imgurl;
                Log.d("pos222", "__________" + imgurl);
                if (imgurl.startsWith("/storage/")) {
                    url = imgurl;
                } else if (!imgurl.startsWith("http://") && !imgurl.startsWith("/storage/")) {
                    url = API_URL + imgurl;
                }
                Log.d("pos222", "__________" + url);
                Glide.with(context)
                        .load(url)
