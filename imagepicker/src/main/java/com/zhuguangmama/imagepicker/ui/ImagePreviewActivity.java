...
//                break;
//        }
        if (v.getId() == R.id.btn_pic_rechoose) {
            finish();
    ...
    public void onImageSingleTap(MotionEvent e) {
        ...
        if (topBar.getVisibility() == View.VISIBLE) {
            ...
            bottomBar.setAnimation(AnimationUtils.loadAnimation(ImagePreviewActivity.this, R.anim.fadeout));
            topBar.setVisibility(View.GONE);
            bottomBar.setVisibility(View.GONE);
        } else {
            topBar.setAnimation(AnimationUtils.loadAnimation(ImagePreviewActivity.this, R.anim.top_in));
            bottomBar.setAnimation(AnimationUtils.loadAnimation(ImagePreviewActivity.this, R.anim.fadein));
